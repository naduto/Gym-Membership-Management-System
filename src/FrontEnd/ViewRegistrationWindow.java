...
public class ViewRegistrationWindow extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ViewRegistrationWindow
     */
    public ViewRegistrationWindow() {
        setVisible(true);
        initComponents();
    ...
    private void viewTable(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_viewTable
        String filename = FileName.REGISTRATION_FILENAME;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewRegistrationWindow().setVisible(true);
            }
        });
    }
